...
{
    public class GetGymPassQueryHandler : IRequestHandler<GetGymPassQuery, GymPassDTO>
    {
        ...
        public GetGymPassQueryHandler(IMapper mapper, IGymPassRepository gymPassRepository, IUsersProfileRepository usersProfileRepository)
        {
            _mapper = mapper;
            _gymPassRepository = gymPassRepository;
            _usersProfileRepository = usersProfileRepository;
        }
        public async Task<GymPassDTO> Handle(GetGymPassQuery request, CancellationToken cancellationToken)
        {
